...
const POKEMONARRAY = [
   {
     thumbnail: ['bulbasaur.gif', 'bulbasaurs.gif'],
     id:'001' ,
     name: 'bulbasaur',
     type: ['grass', 'poison'],
   ...
   {
     thumbnail: ['ivysaur.gif', 'ivysaurs.gif'],
     id:'002',
     name: 'ivysaur',
     type: ['grass', 'poison'],
   ...
   {
     thumbnail: ['venusaur.gif', 'venusaurs.gif'],
     id:'003',
     name: 'venusaur',
     type: ['grass', 'poison'],
   ...
   {
     thumbnail: ['charmander.gif', 'charmanders.gif'],
     id:'004',
     name: 'charmander',
     type: ['fire'],
   ...
   {
     thumbnail: ['charmeleon.gif', 'charmeleons.gif'],
     id:'005',
     name: 'charmeleon',
     type: ['fire'],
   ...
   {
     thumbnail: ['charizard.gif', 'charizards.gif'],
     id:'006',
     name: 'charizard',
     type: ['fire', 'flying'],
   ...
   {
     thumbnail: ['squirtle.gif', 'squirtles.gif'],
     id:'007',
     name: 'squirtle',
     type: ['water'],
   ...
   {
     thumbnail: ['wartortle.gif', 'wartortles.gif'],
     id:'008',
     name: 'wartortle',
     type: ['water'],
   ...
   {
     thumbnail: ['blastoise.gif', 'blastoises.gif'],
     id:'009',
     name: 'blastoise',
     type: ['water'],
   ...
   {
     thumbnail: ['caterpie.gif', 'caterpies.gif'],
     id:'010',
     name: 'caterpie',
     type: ['bug'],
   ...
   {
     thumbnail: ['metapod.gif', 'metapods.gif'],
     id:'011',
     name: 'metapod',
     type: ['bug'],
   ...
   {
     thumbnail: ['butterfree.gif', 'butterfrees.gif'],
     id:'012',
     name: 'butterfree',
     type: ['bug', 'flying'],
   ...
   {
     thumbnail: ['weedle.gif', 'weedles.gif'],
     id:'013',
     name: 'weedle',
     type: ['bug', 'poison'],
   ...
   {
     thumbnail: ['kakuna.gif', 'kakunas.gif'],
     id:'014',
     name: 'kakuna',
     type: ['bug', 'poison'],
   ...
   {
     thumbnail: ['beedrill.gif', 'beedrills.gif'],
     id:'015',
     name: 'beedrill',
     type: ['bug', 'poison'],
   ...
   {
     thumbnail: ['pidgey.gif', 'pidgeys.gif'],
     id:'016',
     name: 'pidgey',
     type: ['flying', 'normal'],
   ...
   {
    thumbnail: ['pidgeotto.gif', 'pidgeottos.gif'],
    id:'017',
    name: 'pidgeotto',
    type: ['flying', 'normal'],
  ...
  {
    thumbnail: ['pidgeot.gif', 'pidgeots.gif'],
    id:'018',
    name: 'pidgeot',
    type: ['flying', 'normal'],
  ...
  {
    thumbnail: ['rattata.gif', 'rattatas.gif'],
    id:'019',
    name: 'rattata',
    type: ['normal'],
  ...
  {
    thumbnail: ['raticate.gif', 'raticates.gif'],
    id:'020',
    name: 'raticate',
    type: ['normal'],
  ...
  {
    thumbnail: ['spearow.gif', 'spearows.gif'],
    id:'021',
    name: 'spearow',
    type: ['flying', 'normal'],
  ...
  {
    thumbnail: ['fearow.gif', 'fearows.gif'],
    id:'022',
    name: 'fearow',
    type: ['flying', 'normal'],
  ...
  {
    thumbnail: ['ekans.gif', 'ekanss.gif'],
    id:'023',
    name: 'ekans',
    type: ['poison'],
  ...
  {
    thumbnail: ['arbok.gif', 'arboks.gif'],
    id:'024',
    name: 'arbok',
    type: ['poison'],
  ...
  {
    thumbnail: ['pikachu.gif', 'pikachus.gif'],
    id:'025',
    name: 'pikachu',
    type: ['electric'],
  ...
  {
    thumbnail: ['raichu.gif', 'raichus.gif'],
    id:'026',
    name: 'raichu',
    type: ['electric'],
  ...
  {
    thumbnail: ['sandshrew.gif', 'sandshrews.gif'],
    id:'027',
    name: 'sandshrew',
    type: ['ground'],
  ...
  {
    thumbnail: ['sandslash.gif', 'sandslashs.gif'],
    id:'028',
    name: 'sandslash',
    type: ['ground'],
  ...
  {
    thumbnail: ['nidoran_f.gif', 'nidoran_fs.gif'],
    id:'029',
    name: 'nidoran',
    type: ['poison'],
  ...
  {
    thumbnail: ['nidorina.gif', 'nidorinas.gif'],
    id:'030',
    name: 'nidorina',
    type: ['poison'],
  ...
  {
    thumbnail: ['nidoqueen.gif', 'nidoqueens.gif'],
    id:'031',
    name: 'nidoqueen',
    type: ['poison', 'ground'],
  ...
  {
    thumbnail: ['nidoran_m.gif', 'nidoran_ms.gif'],
    id:'032',
    name: 'nidoran',
    type: ['poison'],
  ...
  {
    thumbnail: ['nidorino.gif', 'nidorinos.gif'],
    id:'033',
    name: 'nidorino',
    type: ['poison'],
  ...
  {
    thumbnail: ['nidoking.gif', 'nidokings.gif'],
    id:'034',
    name: 'nidoking',
    type: ['poison', 'ground'],
  ...
  {
    thumbnail: ['clefairy.gif', 'clefairys.gif'],
    id:'035',
    name: 'clefairy',
    type: ['fairy'],
  ...
  {
    thumbnail: ['clefable.gif', 'clefables.gif'],
    id:'036',
    name: 'clefable',
    type: ['fairy'],
  ...
  {
    thumbnail: ['vulpix.gif', 'vulpixs.gif'],
    id:'037',
    name: 'vulpix',
    type: ['fire'],
  ...
  {
    thumbnail: ['ninetales.gif', 'ninetaless.gif'],
    id:'038',
    name: 'ninetales',
    type: ['fire'],
  ...
  {
    thumbnail: ['jigglypuff.gif', 'jigglypuffs.gif'],
    id:'039',
    name: 'jigglypuff',
    type: ['fairy', 'normal'],
  ...
  {
    thumbnail: ['wigglytuff.gif', 'wigglytuffs.gif'],
    id:'040',
    name: 'wigglytuff',
    type: ['fairy', 'normal'],
  ...
  {
    thumbnail: ['zubat.gif', 'zubats.gif'],
    id:'041',
    name: 'zubat',
    type: ['poison', 'flying'],
  ...
  {
    thumbnail: ['golbat.gif', 'golbats.gif'],
    id:'042',
    name: 'golbat',
    type: ['poison', 'flying'],
  ...
  {
    thumbnail: ['oddish.gif', 'oddishs.gif'],
    id:'043',
    name: 'oddish',
    type: ['grass', 'poison'],
  ...
  {
    thumbnail: ['gloom.gif', 'glooms.gif'],
    id:'044',
    name: 'gloom',
    type: ['grass', 'poison'],
  ...
  {
    thumbnail: ['vileplume.gif', 'vileplumes.gif'],
    id:'045',
    name: 'vileplume',
    type: ['grass', 'poison'],
  ...
  {
    thumbnail: ['paras.gif', 'parass.gif'],
    id:'046',
    name: 'paras',
    type: ['bug', 'grass'],
  ...
  {
    thumbnail: ['parasect.gif', 'parasects.gif'],
    id:'047',
    name: 'parasect',
    type: ['bug', 'grass'],
  ...
  {
    thumbnail: ['venonat.gif', 'venonats.gif'],
    id:'048',
    name: 'venonat',
    type: ['bug', 'poison'],
  ...
  {
    thumbnail: ['venomoth.gif', 'venomoths.gif'],
    id:'049',
    name: 'venomoth',
    type: ['bug', 'poison'],
  ...
  {
    thumbnail: ['diglett.gif', 'digletts.gif'],
    id:'050',
    name: 'diglett',
    type: ['ground'],
  ...
  {
    thumbnail: ['dugtrio.gif', 'dugtrios.gif'],
    id:'051',
    name: 'dugtrio',
    type: ['ground'],
  ...
  {
    thumbnail: ['meowth.gif', 'meowths.gif'],
    id:'052',
    name: 'meowth',
    type: ['normal'],
  ...
  {
    thumbnail: ['persian.gif', 'persians.gif'],
    id:'053',
    name: 'persian',
    type: ['normal'],
  ...
  {
    thumbnail: ['psyduck.gif', 'psyducks.gif'],
    id:'054',
    name: 'psyduck',
    type: ['water'],
  ...
  {
    thumbnail: ['golduck.gif', 'golducks.gif'],
    id:'055',
    name: 'golduck',
    type: ['water'],
  ...
  {
    thumbnail: ['mankey.gif', 'mankeys.gif'],
    id:'056',
    name: 'mankey',
    type: ['fighting'],
  ...
  {
    thumbnail: ['primeape.gif', 'primeapes.gif'],
    id:'057',
    name: 'primeape',
    type: ['fighting'],
  ...
  {
    thumbnail: ['growlithe.gif', 'growlithes.gif'],
    id:'058',
    name: 'growlithe',
    type: ['fire'],
  ...
  {
    thumbnail: ['arcanine.gif', 'arcanines.gif'],
    id:'059',
    name: 'arcanine',
    type: ['fire'],
  ...
  {
    thumbnail: ['poliwag.gif', 'poliwags.gif'],
    id:'060',
    name: 'poliwag',
    type: ['water'],
  ...
  {
    thumbnail: ['poliwhirl.gif', 'poliwhirls.gif'],
    id:'061',
    name: 'poliwhirl',
    type: ['water'],
  ...
  {
    thumbnail: ['poliwrath.gif', 'poliwraths.gif'],
    id:'062',
    name: 'poliwrath',
    type: ['fighting', 'water'],
  ...
  {
    thumbnail: ['kadabra.gif', 'kadabras.gif'],
    id:'064',
    name: 'kadabra',
    type: ['psychic'],
  ...
  {
    thumbnail: ['alakazam.gif', 'alakazams.gif'],
    id:'065',
    name: 'alakazam',
    type: ['psychic'],
  ...
  {
    thumbnail: ['machop.gif', 'machops.gif'],
    id:'066',
    name: 'machop',
    type: ['fighting'],
  ...
  {
    thumbnail: ['machoke.gif', 'machokes.gif'],
    id:'067',
    name: 'machoke',
    type: ['fighting'],
  ...
  {
    thumbnail: ['machamp.gif', 'machamps.gif'],
    id:'068',
    name: 'machamp',
    type: ['fighting'],
  ...
  {
    thumbnail: ['bellsprout.gif', 'bellsprouts.gif'],
    id:'069',
    name: 'bellsprout',
    type: ['grass', 'poison'],
  ...
  {
    thumbnail: ['weepinbell.gif', 'weepinbells.gif'],
    id:'070',
    name: 'weepinbell',
    type: ['grass', 'poison'],
  ...
  {
    thumbnail: ['victreebel.gif', 'victreebels.gif'],
    id:'071',
    name: 'victreebel',
    type: ['grass', 'poison'],
  ...
  {
    thumbnail: ['tentacool.gif', 'tentacools.gif'],
    id:'072',
    name: 'tentacool',
    type: ['water', 'poison'],
  ...
  {
    thumbnail: ['tentacruel.gif', 'tentacruels.gif'],
    id:'073',
    name: 'tentacruel',
    type: ['water', 'poison'],
  ...
  {
    thumbnail: ['geodude.gif', 'geodudes.gif'],
    id:'074',
    name: 'geodude',
    type: ['rock', 'ground'],
  ...
  {
    thumbnail: ['graveler.gif', 'gravelers.gif'],
    id:'075',
    name: 'graveler',
    type: ['rock', 'ground'],
  ...
  {
    thumbnail: ['golem.gif', 'golems.gif'],
    id:'076',
    name: 'golem',
    type: ['rock', 'ground'],
  ...
  {
    thumbnail: ['ponyta.gif', 'ponytas.gif'],
    id:'077',
    name: 'ponyta',
    type: ['fire'],
  ...
  {
    thumbnail: ['rapidash.gif', 'rapidashs.gif'],
    id:'078',
    name: 'rapidash',
    type: ['fire'],
  ...
  {
    thumbnail: ['slowpoke.gif', 'slowpokes.gif'],
    id:'079',
    name: 'slowpoke',
    type: ['water', 'psychic'],
  ...
  {
    thumbnail: ['slowbro.gif', 'slowbros.gif'],
    id:'080',
    name: 'slowbro',
    type: ['water', 'psychic'],
  ...
  {
    thumbnail: ['magnemite.gif', 'magnemites.gif'],
    id:'081',
    name: 'magnemite',
    type: ['electric', 'steel'],
  ...
  {
    thumbnail: ['magneton.gif', 'magnetons.gif'],
    id:'082',
    name: 'magneton',
    type: ['electric', 'steel'],
  ...
  {
    thumbnail: ['farfetchd.gif', 'farfetchds.gif'],
    id:'083',
    name: "farfetch'd",
    type: ['flying', 'normal'],
    description: "Farfetch'd is always seen with a stick from a grass of some sort. Apparently, there are good sticks and bad sticks. This Pokémon has been known to fight with others over sticks.",
  },
  {
    thumbnail: ['doduo.gif', 'doduos.gif'],
    id:'084',
    name: 'doduo',
    type: ['normal', 'flying'],
  ...
  {
    thumbnail: ['dodrio.gif', 'dodrios.gif'],
    id:'085',
    name: 'dodrio',
    type: ['normal', 'flying'],
  ...
  {
    thumbnail: ['dewgong.gif', 'dewgongs.gif'],
    id:'087',
    name: 'dewgong',
    type: ['ice', 'water'],
  ...
  {
    thumbnail: ['grimer.gif', 'grimers.gif'],
    id:'088',
    name: 'grimer',
    type: ['poison'],
  ...
  {
    thumbnail: ['shellder.gif', 'shellders.gif'],
    id:'090',
    name: 'shellder',
    type: ['water'],
  ...
  {
    thumbnail: ['cloyster.gif', 'cloysters.gif'],
    id:'091',
    name: 'cloyster',
    type: ['ice', 'water'],
  ...
  {
    thumbnail: ['gastly.gif', 'gastlys.gif'],
    id:'092',
    name: 'gastly',
    type: ['ghost', 'poison'],
  ...
  {
    thumbnail: ['haunter.gif', 'haunters.gif'],
    id:'093',
    name: 'haunter',
    type: ['ghost', 'poison'],
  ...
  {
    thumbnail: ['gengar.gif', 'gengars.gif'],
    id:'094',
    name: 'gengar',
    type: ['ghost', 'poison'],
  ...
  {
    thumbnail: ['drowzee.gif', 'drowzees.gif'],
    id:'096',
    name: 'drowzee',
    type: ['psychic'],
  ...
  {
    thumbnail: ['hypno.gif', 'hypnos.gif'],
    id:'097',
    name: 'hypno',
    type: ['psychic'],
  ...
  {
    thumbnail: ['krabby.gif', 'krabbys.gif'],
    id:'098',
    name: 'krabby',
    type: ['water'],
  ...
  {
    thumbnail: ['kingler.gif', 'kinglers.gif'],
    id:'099',
    name: 'kingler',
    type: ['water'],
  ...
  {
    thumbnail: ['voltorb.gif', 'voltorbs.gif'],
    id:'100',
    name: 'voltorb',
    type: ['electric'],
  ...
  {
    thumbnail: ['electrode.gif', 'electrodes.gif'],
    id:'101',
    name: 'electrode',
    type: ['electric'],
  ...
  {
    thumbnail: ['exeggcute.gif', 'exeggcutes.gif'],
    id:'102',
    name: 'exeggcute',
    type: ['grass', 'psychic'],
  ...
  {
    thumbnail: ['exeggutor.gif', 'exeggutors.gif'],
    id:'103',
    name: 'exeggutor',
    type: ['grass', 'psychic'],
  ...
  {
    thumbnail: ['cubone.gif', 'cubones.gif'],
    id:'104',
    name: 'cubone',
    type: ['ground'],
  ...
  {
    thumbnail: ['marowak.gif', 'marowaks.gif'],
    id:'105',
    name: 'marowak',
    type: ['ground'],
  ...
  {
    thumbnail: ['hitmonlee.gif', 'hitmonlees.gif'],
    id:'106',
    name: 'hitmonlee',
    type: ['fighting'],
  ...
  {
    thumbnail: ['hitmonchan.gif', 'hitmonchans.gif'],
    id:'107',
    name: 'hitmonchan',
    type: ['fighting'],
  ...
  {
    thumbnail: ['lickitung.gif', 'lickitungs.gif'],
    id:'108',
    name: 'lickitung',
    type: ['normal'],
  ...
  {
    thumbnail: ['koffing.gif', 'koffings.gif'],
    id:'109',
    name: 'koffing',
    type: ['poison'],
  ...
  {
    thumbnail: ['weezing.gif', 'weezings.gif'],
    id:'110',
    name: 'weezing',
    type: ['poison'],
  ...
  {
    thumbnail: ['rhyhorn.gif', 'rhyhorns.gif'],
    id:'111',
    name: 'rhyhorn',
    type: ['ground', 'rock'],
  ...
  {
    thumbnail: ['rhydon.gif', 'rhydons.gif'],
    id:'112',
    name: 'rhydon',
    type: ['ground', 'rock'],
  ...
  {
    thumbnail: ['chansey.gif', 'chanseys.gif'],
    id:'113',
    name: 'chansey',
    type: ['normal'],
  ...
  {
    thumbnail: ['tangela.gif', 'tangelas.gif'],
    id:'114',
    name: 'tangela',
    type: ['grass'],
  ...
  {
    thumbnail: ['kangaskhan.gif', 'kangaskhans.gif'],
    id:'115',
    name: 'kangaskhan',
    type: ['normal'],
  ...
  {
    thumbnail: ['horsea.gif', 'horseas.gif'],
    id:'116',
    name: 'horsea',
    type: ['water'],
  ...
  {
    thumbnail: ['seadra.gif', 'seadras.gif'],
    id:'117',
    name: 'seadra',
    type: ['water'],
  ...
  {
    thumbnail: ['goldeen.gif', 'goldeens.gif'],
    id:'118',
    name: 'goldeen',
    type: ['water'],
  ...
  {
    thumbnail: ['seaking.gif', 'seakings.gif'],
    id:'119',
    name: 'seaking',
    type: ['water'],
  ...
  {
    thumbnail: ['staryu.gif', 'staryus.gif'],
    id:'120',
    name: 'staryu',
    type: ['water'],
  ...
  {
    thumbnail: ['starmie.gif', 'starmies.gif'],
    id:'121',
    name: 'starmie',
    type: ['water', 'psychic'],
  ...
  {
    thumbnail: ['mr.mime.gif', 'mr.mimes.gif'],
    id:'122',
    name: 'mr. mime',
    type: ['psychic', 'fairy'],
  ...
  {
    thumbnail: ['scyther.gif', 'scythers.gif'],
    id:'123',
    name: 'scyther',
    type: ['bug', 'flying'],
  ...
  {
    thumbnail: ['electabuzz.gif', 'electabuzzs.gif'],
    id:'125',
    name: 'electabuzz',
    type: ['electric'],
  ...
  {
    thumbnail: ['magmar.gif', 'magmars.gif'],
    id:'126',
    name: 'magmar',
    type: ['fire'],
  ...
  {
    thumbnail: ['pinsir.gif', 'pinsirs.gif'],
    id:'127',
    name: 'pinsir',
    type: ['bug'],
  ...
  {
    thumbnail: ['tauros.gif', 'tauross.gif'],
    id:'128',
    name: 'tauros',
    type: ['normal'],
  ...
  {
    thumbnail: ['magikarp.gif', 'magikarps.gif'],
    id:'129',
    name: 'magikarp',
    type: ['water'],
  ...
  {
    thumbnail: ['gyarados.gif', 'gyaradoss.gif'],
    id:'130',
    name: 'gyarados',
    type: ['water', 'flying'],
  ...
  {
    thumbnail: ['lapras.gif', 'laprass.gif'],
    id:'131',
    name: 'lapras',
    type: ['ice', 'water'],
  ...
  {
    thumbnail: ['ditto.gif', 'dittos.gif'],
    id:'132',
    name: 'ditto',
    type: ['normal'],
  ...
  {
    thumbnail: ['eevee.gif', 'eevees.gif'],
    id:'133',
    name: 'eevee',
    type: ['normal'],
  ...
  {
    thumbnail: ['vaporeon.gif', 'vaporeons.gif'],
    id:'134',
    name: 'vaporeon',
    type: ['water'],
  ...
  {
    thumbnail: ['jolteon.gif', 'jolteons.gif'],
    id:'135',
    name: 'jolteon',
    type: ['electric'],
  ...
  {
    thumbnail: ['flareon.gif', 'flareons.gif'],
    id:'136',
    name: 'flareon',
    type: ['fire'],
  ...
  {
    thumbnail: ['porygon.gif', 'porygons.gif'],
    id:'137',
    name: 'porygon',
    type: ['normal'],
  ...
  {
    thumbnail: ['omanyte.gif', 'omanytes.gif'],
    id:'138',
    name: 'omanyte',
    type: ['water', 'rock'],
  ...
  {
    thumbnail: ['omastar.gif', 'omastars.gif'],
    id:'139',
    name: 'omastar',
    type: ['water', 'rock'],
  ...
  {
    thumbnail: ['kabuto.gif', 'kabutos.gif'],
    id:'140',
    name: 'kabuto',
    type: ['rock', 'water'],
  ...
  {
    thumbnail: ['kabutops.gif', 'kabutopss.gif'],
    id:'141',
    name: 'kabutops',
    type: ['rock', 'water'],
  ...
  {
    thumbnail: ['aerodactyl.gif', 'aerodactyls.gif'],
    id:'142',
    name: 'aerodactyl',
    type: ['flying', 'rock'],
  ...
  {
    thumbnail: ['snorlax.gif', 'snorlaxs.gif'],
    id:'143',
    name: 'snorlax',
    type: ['normal'],
  ...
  {
    thumbnail: ['articuno.gif', 'articunos.gif'],
    id:'144',
    name: 'articuno',
    type: ['ice', 'flying'],
  ...
  {
    thumbnail: ['zapdos.gif', 'zapdoss.gif'],
    id:'145',
    name: 'zapdos',
  ...
  {
    thumbnail: ['moltres.gif', 'moltress.gif'],
    id:'146',
    name: 'moltres',
    type: ['fire', 'flying'],
  ...
  {
    thumbnail: ['dratini.gif', 'dratinis.gif'],
    id:'147',
    name: 'dratini',
    type: ['dragon'],
  ...
  {
    thumbnail: ['dragonair.gif', 'dragonairs.gif'],
    id:'148',
    name: 'dragonair',
    type: ['dragon'],
  ...
  {
    thumbnail: ['dragonite.gif', 'dragonites.gif'],
    id:'149',
    name: 'dragonite',
    type: ['dragon', 'flying'],
  ...
  {
    thumbnail: ['mewtwo.gif', 'mewtwos.gif'],
    id:'150',
    name: 'mewtwo',
    type: ['psychic'],
